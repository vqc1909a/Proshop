...
const HomeScreen = lazy(() =>
	import(/* webpackChunkName: "HomeScreen" */ "screens/HomeScreen")
);
const ProductScreen = lazy(() =>
	import(/* webpackChunkName: "ProductScreen" */ "screens/ProductScreen")
);
const CartScreen = lazy(() =>
	import(/* webpackChunkName: "CartScreen" */ "screens/CartScreen")
);
const LoginScreen = lazy(() =>
	import(/* webpackChunkName: "LoginScreen" */ "screens/LoginScreen")
);
const RegisterScreen = lazy(() =>
	import(/* webpackChunkName: "RegisterScreen" */ "screens/RegisterScreen")
);
const ProfileScreen = lazy(() =>
	import(/* webpackChunkName: "ProfileScreen" */ "screens/ProfileScreen")
);
const ChangePasswordScreen = lazy(() =>
	import(
		/* webpackChunkName: "ChangePasswordScreen" */ "screens/ChangePasswordScreen"
	)
);
const OrderScreen = lazy(() =>
	import(/* webpackChunkName: "OrderScreen" */ "screens/OrderScreen")
);
const OrderAdminScreen = lazy(() =>
	import(
		/* webpackChunkName: "OrderAdminScreen" */ "screens/admin/OrderAdminScreen"
	)
);
...
const CheckoutScreen = lazy(() =>
	import(/* webpackChunkName: "CheckoutScreen" */ "screens/CheckoutScreen")
);

//Componentes del Checkout Layout
const Shipping = lazy(() =>
	import(
		/* webpackChunkName: "Shipping" */ "components/pages/checkout/Shipping"
	)
);
const Payment = lazy(() =>
	import(/* webpackChunkName: "Payment" */ "components/pages/checkout/Payment")
);
const PlaceOrder = lazy(() =>
	import(
		/* webpackChunkName: "PlaceOrder" */ "components/pages/checkout/PlaceOrder"
	)
);
			...
			<main className="py-3">
				<Container>
					<Routes>
						...
						<Route
							path="/"
							element={<ProtectedRoutePrivate redirectPath="/auth/login" />}
						>
							<Route
						...
						<Route
							path="/"
							element={<ProtectedRouteAdmin redirectPath="/auth/login" />}
						>
							<Route
								path="admin/orders"
								element={<OrderAdminScreen></OrderAdminScreen>}
							></Route>
							<Route
								path="admin/products"
								element={<ProductAdminScreen></ProductAdminScreen>}
							></Route>
							<Route
								path="admin/users"
								element={<UserAdminScreen></UserAdminScreen>}
							></Route>
						</Route>
