...
import { useEditImageProductMutation, useGetProductByIdQuery } from "redux/slices/productsApiSlice"
...
function ModalEditImageProduct(props) {
  ...
  const [editImageProduct, {isError, isSuccess ,isLoading, error, data, reset}] = useEditImageProductMutation();
        ...
        <Modal.Body>
          ...
          <Formik
            ...
            onSubmit={async (values) => {
              ...
              try{
                ...
                await editImageProduct({token, idProduct: values.id, newProduct: formData}).unwrap();
          ...
          >
            {({ handleSubmit, handleChange, values, touched, errors }) => (
              <Form noValidate onSubmit={handleSubmit} ref={formEditImageProduct}>
                ...
                <Row className="mb-3">
                  ...
                  <Row>
                    <Col xs={6}>
                      <Image src={values.image} width={"100%"} height={"300"}></Image>
                    </Col>
                  </Row>
                </Row>
