...
const usersApiSlice = apiSlice.injectEndpoints({
    endpoints: (builder) => ({
        ...
        getUserById: builder.query({
            ...
            keepUnusedDataFor: 5,
            providesTags: (result, error, { userId }) => [{ type: 'UserAdmin', id: userId }],
        }),
        ...
        editUser: builder.mutation({
            ...
            invalidatesTags: (result, error, {userId}) => ["UsersAdmin", { type: 'UserAdmin', id: userId }],
        }),
...
export const { useGetUsersQuery, useGetUserByIdQuery, useCreateUserMutation, useEditUserMutation, useEditImageUserMutation, useDeleteUserMutation } = usersApiSlice;
