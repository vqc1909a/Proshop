...
export const { useGetProfileMutation, useUpdateProfileMutation, useUpdatePasswordMutation, useAddShippingAddressMutation,   useChangeSelectedShippingAddressMutation } = profileApiSlice;
